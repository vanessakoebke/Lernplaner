...
public class Kalender {
    ...
    /**
     * Erzeugt ein UtilDateModel mit einem voreingestellten Datum basierend auf dem
     * aktuellen Semester und einem Offset in Tagen. * @param offsetTage Die Anzahl
     * der Tage, die zum Semesterstart addiert werden.
     * 
    ...
    public static UtilDateModel getModellMitSemesterdatum(int offsetTage) {
        ...
        // Annahme:
        // Wintersemester (WS) beginnt am 1. Oktober (Monat 9) und endet am 31. März
        // (Monat 2)
        // Sommersemester (SS) beginnt am 1. April (Monat 3) und endet am 30. September
        // (Monat 8)
        ...
        model.setDate(zieldatum.get(Calendar.YEAR), zieldatum.get(Calendar.MONTH),
    ...
    private static int getStartMonat(int aktuellerMonat) {
        int startMonat;
        // Wenn der aktuelle Monat zwischen April (3) und September (8) liegt, ist SS
        // aktiv.
        ...
        // Wenn der aktuelle Monat zwischen Oktober (9) und März (2) liegt, ist WS
        // aktiv.
        else {
    ...
    public static boolean isSommersemester() {
        Month startMonat = Month.MARCH;
        Month endMonat = Month.AUGUST;
        Month aktuellerMonat = LocalDate.now().getMonth();
        return aktuellerMonat.getValue() >= startMonat.getValue() && aktuellerMonat.getValue() <= endMonat.getValue();
    }
}
